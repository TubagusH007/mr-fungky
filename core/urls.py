...
from inventory.views import proses_suara_massal, home, halaman_prediksi, simpan_data_historis, api_kalkulasi_prediksi, halaman_gudang, update_stok_manual, terapkan_prediksi_stok, halaman_login, halaman_register, proses_logout, hapus_riwayat, download_excel_stok
